...
####+BEGIN: bx:icm:python:cmnd:classHead :cmndName "argsAndParamsProc" :comment "" :parsMand "" :parsOpt "" :argsMin "2" :argsMax "999" :asFunc "" :interactiveP ""
"""
*  [[elisp:(org-cycle)][| ]] [[elisp:(org-show-subtree)][|=]] [[elisp:(show-children 10)][|V]] [[elisp:(bx:orgm:indirectBufOther)][|>]] [[elisp:(bx:orgm:indirectBufMain)][|I]] [[elisp:(blee:ppmm:org-mode-toggle)][|N]] [[elisp:(org-top-overview)][|O]] [[elisp:(progn (org-shifttab) (org-content))][|C]] [[elisp:(delete-other-windows)][|1]]  ICM-Cmnd       :: /argsAndParamsProc/ parsMand= parsOpt= argsMin=2 argsMax=999 asFunc= interactive=  [[elisp:(org-cycle)][| ]]
"""
class argsAndParamsProc(icm.Cmnd):
    cmndParamsMandatory = [ ]
    cmndParamsOptional = [ ]
    cmndArgsLen = {'Min': 2, 'Max': 999,}

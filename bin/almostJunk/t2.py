...
#+end_org """
import typing
icmInfo: typing.Dict[str, typing.Any] = { 'moduleName': ['t2'], }
icmInfo['version'] = '202207071834'
icmInfo['status']  = 'inUse'
icmInfo['panel'] = 't2-Panel.org'
...
####+BEGIN: bx:icm:python:func :funcType "CsFrmWrk" :funcName "commonParamsSpecify" :comment "Params Spec for: " :retType "Void" :deco "" :argsList "icmParams"
""" #+begin_org
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(outline-show-branches+toggle)][|=]] [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  F-CsFrmWrk [[elisp:(outline-show-subtree+toggle)][||]] /commonParamsSpecify/ =Params Spec for: = retType=Void argsList=(icmParams)  [[elisp:(org-cycle)][| ]]
#+end_org """

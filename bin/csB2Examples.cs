...
csInfo['moduleName'] = "csB2Examples"
####+END:

####+BEGIN: bx:cs:py:version-timestamp :style "date"
csInfo['version'] = "202209102144"
####+END:
...
""" #+begin_org
*  This file:/bisos/git/auth/bxRepos/bisos/bpip1/bin/csB2Examples.cs :: [[elisp:(org-cycle)][| ]]
...
####+END:
        ...
        b.cs.examples.menuChapter('=Tests=  *All Examples As Tests*')
...
#+end_org """
class dirCreateExamples(b.cs.Cmnd):
    cmndParamsMandatory = [ ]
    cmndParamsOptional = [ ]
    cmndArgsLen = {'Min': 0, 'Max': 0,}
...
#+end_org """
class exceptionExamples(b.cs.Cmnd):
    cmndParamsMandatory = [ ]
    cmndParamsOptional = [ ]
    cmndArgsLen = {'Min': 0, 'Max': 0,}
...
#+end_org """
class allExamplesAsTests(b.cs.Cmnd):
    cmndParamsMandatory = [ ]
    cmndParamsOptional = [ ]
    cmndArgsLen = {'Min': 0, 'Max': 0,}
...
** [[elisp:(org-cycle)][| *CmndDesc:* | ]] This is an example of a CmndSvc with lots of features.
        ...
        if b.subProc.WOpW(invedBy=self, log=1).bash(
                f"""{myName}  {verbosity} -i sameInstanceEx""",
        ).isProblematic():  return(b.io.eh.badOutcome(cmndOutcome))
